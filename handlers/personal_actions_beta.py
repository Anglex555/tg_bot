...
async def start(message: types.Message):
    ...
    elif(str(message.from_user.first_name) != 'None'):
...
async def start(message):
    ...
    if message.text == 'Назад ↩️':
        ...
        if(message.from_user.id in administrators):
            message.bot.send_message(message.chat.id, 'Права подтверждены'.format(message.from_user)) 
        else:
        ...
        if(user_i.first_name == 'None' or user_i.first_name == 'none'):
            first = '...'
        else:
            first = user_i.first_name
        if(user_i.last_name == 'None' or user_i.last_name == 'none'):
            last = '...'
        else:
        ...
        for user_i in users:
            ...
            if(user_i.last_name is None or user_i.last_name == 'None' or user_i.last_name == 'none'):
                ...
                last = user_i.last_name
            if(user_i.id is None or user.id == 'None' or user.id == 'none'):
                uid = 'None'
            else:
                uid = user.id
            cmd += 'User' + str(i) + ':\n' + '\t\t\t\tID: ' + str(uid) + '\n' + '\t\t\t\tFirst name: ' + first + '\n' + '\t\t\t\tLast name: ' + last + '\n\n'
